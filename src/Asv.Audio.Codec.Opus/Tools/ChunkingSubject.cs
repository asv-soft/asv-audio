...
public class ChunkingSubject<T> : DisposableOnceWithCancel
{
    ...
    public Observable<ReadOnlyMemory<T>> OnData => _onData;
    public ChunkingSubject(Observable<ReadOnlyMemory<T>> src, int chunkByteSize, bool useArrayPool = true)
    {
